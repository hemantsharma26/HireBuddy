...
const env = {
  ...
  OTP_RATE_LIMIT_WINDOW_MS: parseInt(process.env.OTP_RATE_LIMIT_WINDOW_MS) || 3600000, // 1 hour
  OTP_RATE_LIMIT_MAX_REQUESTS: parseInt(process.env.OTP_RATE_LIMIT_MAX_REQUESTS) || 5,
  CHAT_RATE_LIMIT_WINDOW_MS: parseInt(process.env.CHAT_RATE_LIMIT_WINDOW_MS) || 60000, // 1 minute
  CHAT_RATE_LIMIT_MAX_REQUESTS: parseInt(process.env.CHAT_RATE_LIMIT_MAX_REQUESTS) || 50,
